        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                <div class="card-body-icon">
                                    <i class="fas fa-fw fa-clipboard"></i> <i class="fas fa-fw fa-map-marker"></i>
                                </div>
                                <div class="mr-5">Book Locations</div>
                            </div>
                ...
                <div class="card mb-3">
                  ...
                  $ret="SELECT * from tms_vehicle ORDER BY v_id ASC "; //get all bookings
                ...
                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($row->v_img)) {
                                                echo '<img src="' . $row->v_img . '" style="max-width: 100px; max-height: 100px; float: left; margin-right: 10px;">';
                                                }
                                                ?>
                                             <?php
                                            if ($row->v_name == "AZIZAH BINTI OHAMZAH") {
