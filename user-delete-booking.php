        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="text" readonly placeholder="<?php echo $row->u_startbooktime;?>" class="form-control"   name="u_startbooktime">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">End Booking Time</label>
                <input type="text" readonly placeholder="<?php echo $row->u_endbooktime;?>" class="form-control"   name="u_endbooktime">
            </div>
            <div class="form-group">
